...
void TEST_export_import_bo(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_io(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_io_latency(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_io_throughput(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_io_runlist_latency(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_io_runlist_throughput(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_noop_io_with_dup_bo(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_shim_umq_vadd(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_shim_umq_memtiles(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_shim_umq_ddr_memtile(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_shim_umq_remote_barrier(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_txn_elf_flow(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_cmd_fence_host(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
void TEST_cmd_fence_device(uint32_t, std::shared_ptr<shim_xdna::device>, arg_type&);
...
struct test_case { // Definition of one test case
  ...
  enum test_mode mode;
  bool (*dev_filter)(uint32_t id, shim_xdna::device *dev);
  void (*func)(uint32_t id, std::shared_ptr<shim_xdna::device> dev, arg_type& arg);
  arg_type arg;
};
...
bool
no_dev_filter(uint32_t id, shim_xdna::device* dev)
{
  return true;
}

bool
skip_dev_filter(uint32_t id, shim_xdna::device* dev)
{
  return false;
}

bool
dev_filter_xdna(uint32_t id, shim_xdna::device* dev)
{
  return is_xdna_dev(dev);
}

bool
dev_filter_not_xdna(uint32_t id, shim_xdna::device* dev)
{
  return !is_xdna_dev(dev);
}

bool
dev_filter_is_aie2(uint32_t id, shim_xdna::device* dev)
{
  if (!is_xdna_dev(dev))
    return false;
...
bool
dev_filter_is_aie4(uint32_t id, shim_xdna::device* dev)
{
  if (!is_xdna_dev(dev))
    return false;
  //  auto device_id = device_query<query::pcie_device>(dev);
...
bool
dev_filter_is_aie(uint32_t id, shim_xdna::device* dev)
{
...
void
TEST_get_xrt_info(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_get_os_info(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_get_total_devices(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_get_bdf_info_and_get_device_id(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  throw std::runtime_error("TODO(max): re-enable TEST_get_bdf_info_and_get_device_id");
//  auto is_user = arg[0];
//  auto devinfo = get_total_devices(is_user);
//  for (uint32_type i = 0; i < devinfo.first; i++) {
...
void
TEST_get_mgmtpf_device(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_query_userpf(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_create_destroy_hw_context(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_create_free_debug_bo(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto dev = sdev.get();
...
void
TEST_create_free_bo(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto dev = sdev.get();
...
void
TEST_sync_bo(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
TEST_sync_bo_off_size(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto boflags = static_cast<unsigned int>(arg[0]);
  auto ext_boflags = static_cast<unsigned int>(arg[1]);
  auto size = static_cast<size_t>(arg[2]);
...
void
TEST_map_read_bo(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto dev = sdev.get();
  auto size = static_cast<size_t>(arg[0]);
...
void
TEST_map_bo(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto boflags = static_cast<unsigned int>(arg[0]);
  auto ext_boflags = static_cast<unsigned int>(arg[1]);
  auto size = static_cast<size_t>(arg[2]);
...
void
TEST_open_close_cu_context(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
  auto dev = sdev.get();
  hw_ctx hwctx{dev};
...
void
TEST_create_destroy_hw_queue(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, arg_type& arg)
{
...
void
run_test(int id, const test_case& test, bool force, const uint32_t& num_of_devices)
{
