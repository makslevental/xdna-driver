...
void
TEST_shim_umq_remote_barrier(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, const std::vector<uint64_t>& arg)
{
  auto dev = sdev.get();
...
void
TEST_shim_umq_ddr_memtile(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, const std::vector<uint64_t>& arg)
{
  auto dev = sdev.get();
...
void
TEST_shim_umq_memtiles(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, const std::vector<uint64_t>& arg)
{
  auto dev = sdev.get();
...
void
TEST_shim_umq_vadd(uint32_t id, std::shared_ptr<shim_xdna::device> sdev, const std::vector<uint64_t>& arg)
{
  auto dev = sdev.get();
